...
double Math::alnorm ( double x, bool upper )
...
double Math::gammad ( double x, double p, int *ifault )
...
double Math::ppchi2 ( double p, double v, double g, int *ifault )
...
double Math::ppnd ( double p, int *ifault )
